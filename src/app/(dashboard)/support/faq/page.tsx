...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    a: [
      ...
      "Automatic subscription renewal through PayGlocal is planned; until then, renewals may be handled manually by the LetzShopy team and confirmed over email or invoice.",
    ],
  },
  {
    category: "Subscriptions & billing",
    ...
    a: [
      ...
      "Payment gateway providers such as PayGlocal may charge their own transaction fees under the applicable merchant arrangement.",
