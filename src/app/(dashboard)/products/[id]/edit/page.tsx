  ...
  return (
    <main className="p-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            onClick={async (e) => {
              ...
              // go back to list so user sees the new item
      ...
      <form onSubmit={submit} onKeyDown={swallowEnter} className="space-y-6">
        ...
        {/* Save */}
        <div>
          <button type="submit" disabled={busy} className="rounded bg-blue-600 text-white px-4 py-2 text-sm hover:bg-blue-700 disabled:opacity-50">
